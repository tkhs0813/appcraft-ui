<script lang="ts">
	...
	export type ContentEditorShellItem = {
		id: string;
		title: string;
		description?: string;
		meta?: string;
	...
	let {
		title = 'ContentEditorShell',
		description = 'Structured editor shell with title, toolbar, metadata, and content slot.',
		items = [],
